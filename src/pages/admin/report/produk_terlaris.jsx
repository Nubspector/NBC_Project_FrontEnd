...
import { reportProdukTerlaris } from "../../../api/admin/report"; // Ganti endpoint sesuai laporan produk terlaris

const ProdukTerlarisReportPage = () => {
    ...
    const fetchLaporan = async () => {
        try {
            const response = await reportProdukTerlaris({ tahun, bulan }); // API request dengan parameter tahun dan bulan
            ...
            if(response.laporan.length === 0) {
                toast.error("Tidak Ada Penjualan Di Bulan Tersebut!");
            }
        } catch (error) {
    ...
    return (
        <div className="p-4">
            <h1 className="text-2xl font-bold text-center mb-4">Laporan Produk Terlaris</h1>
                ...
                <>
                    ...
                    >
                        ...
                        <h3 className="text-lg font-bold text-center my-4">
                            LAPORAN 10 PRODUK PALING LARIS
                        </h3>
                        ...
                        <table className="w-full border-collapse border border-gray-400 text-sm mb-4">
                            <thead>
                                <tr>
                                    ...
                                    <th className="border border-gray-400 p-2">Jumlah Pembelian</th>
                                </tr>
                            </thead>
                            <tbody>
                                {laporan.map((item, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="border border-gray-400 p-2">{item.nama_produk}</td>
                    ...
                    {isModalOpen && (
                        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
                            <div className="bg-white rounded-md p-8 px-8">
                                <div ref={reportRef}>
                                    <div
                                        className="p-8 border border-gray-300 rounded-md bg-white shadow-md"
                                        style={{
                                            width: "190mm",
                                            minHeight: "240mm",
                                            margin: "auto",
...
export default ProdukTerlarisReportPage;
